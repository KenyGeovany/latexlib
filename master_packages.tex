...
% TITLE SECTION FONT AND SIZE (2025.06.25)
% \fontsize{size}{line spacing, typically size+6}
\usepackage{titlesec}
\titleformat{\section}
...
% ADVANCED TYPOGRAPHY
% For text
%\usepackage{calligra} % Tipo de fuente cursiva. Use \calligra. PROBLEMA CON ARXIV
% For math text
...
%\usepackage{MnSymbol} % Modifica el estilo de los símbolos matemáticos. PROBLEMA CON ARXIV
...
%(12.06.2024) Repited in thesis
%\bm{\alpha}
\usepackage{bm} %Greek letters in Bold font

% Redefine spaces in prood environmnet (17.07.2025)
\usepackage{etoolbox}
\pretocmd{\proof}{\vspace{0pt}}{}{}  % above
\apptocmd{\endproof}{\vspace{0pt}}{}{}  % below